...
[前往 GitHub Releases 下载](https://github.com/SimonZhangM/XplorOne/releases) · [快速开始](./docs/getting-started_zh-CN.md) · [参与讨论](https://github.com/SimonZhangM/XplorOne/discussions)
...
- 本仓库中的源代码并未以开源许可证提供
- 仓库层面的专有授权边界见 [LICENSE.md](./LICENSE.md)
