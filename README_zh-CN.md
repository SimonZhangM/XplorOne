...
[前往 GitHub Releases 下载](../../releases) · [快速开始](./docs/getting-started.md) · [参与讨论](../../discussions)

---

![XplorOne 主界面截图](./docs/assets/xplorone-main-screenshot.png)
...
- **AI 帮你查询、准备录入草稿和分析财务，而不只是聊天**  
  你可以直接用自然语言提问、查看结构、理解趋势、准备录入草稿，而不必总是靠手动筛选和翻表。

- **它是为一人公司和小型工作室设计的，不是企业级财务大系统**  
  XplorOne 更适合自己做业务、自己经营、自己管理收入与支出的人，而不是大型团队协同财务系统。

- **清晰的边界，本身就是产品价值的一部分**  
  AI 可以辅助查询、理解、分析和准备录入草稿，但任何写入都必须经过用户确认。
...
它更强调：在本地优先的账本工作流上，做查询、草稿准备和分析，并把写入边界保留给用户自己。

更详细的说明，请见：[隐私与 AI 边界](./docs/privacy-and-ai-boundaries.md)

## 快速开始

1. [下载最新 Windows 版本](../../releases)  
2. 首次启动后创建或打开一个账本  
3. 先直接开始本地记账、查看报表和使用基础查询  
4. 如果你需要 AI 辅助查询、录入草稿和分析，再配置自己的 API Key

完整说明请见：[快速开始](./docs/getting-started.md) 与 [BYOK 配置说明](./docs/byok-setup.md)

## 当前发布状态

- **Windows 是当前正式发布线**
- **即使没有 API Key，也可以完成本地记账、查看财务报表和基础查询**
- **AI 辅助查询、录入草稿和分析功能需要用户自行配置 API Key**
...
- **[Discussions](../../discussions)** —— 问题、想法、反馈与产品讨论
- **[Issues](../../issues)** —— bug、安装问题和可明确处理的问题
- **[Releases](../../releases)** —— 下载版本与查看更新说明
