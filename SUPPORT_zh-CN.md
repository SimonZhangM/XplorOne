...
详细说明请见：[隐私与 AI 边界](./docs/privacy-and-ai-boundaries_zh-CN.md) 和 [本地 API 与 MCP](./docs/local-api-and-mcp_zh-CN.md)。
...
- [隐私说明](./PRIVACY_zh-CN.md)
- [安全说明](./SECURITY_zh-CN.md)
- [数据保存与备份恢复](./docs/data-storage-and-backup_zh-CN.md)
- [AI 助手行为说明](./docs/ai-assistant-behavior_zh-CN.md)
- [本地 API 与 MCP](./docs/local-api-and-mcp_zh-CN.md)
- [Releases](https://github.com/SimonZhangM/XplorOne/releases)
